					...
					<div class="single-blog-post">
						...
						<div class="pager-area">
							<ul class="pager pull-right">
								@if($pre)	
									<li><a href="{{ url('/blog-single/'. $pre)}}">Pre</a></li>
								@endif
						...
						@if($value['level'] == 0)
							<li class="media" >
								...
								<div class="media-body">
									...
									<a class="btn btn-primary reply" id="{{ $value['id'] }}"><i class="fa fa-reply"></i>Replay</a>
								</div>
							</li>
							@foreach ($cmt as $key2 => $value2) 
