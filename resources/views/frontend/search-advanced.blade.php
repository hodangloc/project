				...
				<div class="left-sidebar">
					...
					<div class="price-range"><!--price-range-->
						...
						<div class="well text-center">
							 <input type="text" class="span2" value="111" data-slider-min="0" data-slider-max="200" data-slider-step="10" data-slider-value="[0,200]" id="sl2" ><br />
					...
					<div class="search-price">
						<div class="col-sm-9">
							<div class="blog-post-area">
								<form action="{{ route('search.advanced') }}" method="GET" enctype="multipart/form-data">
								@csrf
							...
							@foreach ($product as $key => $value)
								...
								<div class="col-sm-4">
									<div class="product-image-wrapper">
										<div class="single-products search-price">
											...
											<div class="product-overlay">
												<div class="overlay-content">
													<h2>{{ $value->price }}</h2>
													<p>{{ $value->name }}</p>
													<button type="submit" name="add" id="" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>		
												</div>
											</div>
										</div>
										<div class="choose">
...
<script>
	$(document).ready(function(){
		...
		$(".slider-track").click(function(){
			var getPrice = $(this).closest(".slider-horizontal").find(".tooltip-inner").text();
			// alert(getPrice);
			$.ajax({
				type: "POST",
				url: "{{ url('/search/ajax') }}",
				...
				success:function(res){
					...
					Object.keys(res).map(function(key, index){
						var getImage = JSON.parse(res[key]['image']);
							image = getImage[0];
