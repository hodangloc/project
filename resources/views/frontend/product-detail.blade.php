					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{ asset('uploads/product/'. $image) }}" alt="" class="imgBig" />
								<a href="{{ asset('uploads/product/'. $image) }}" rel="prettyPhoto" class="zoom"><h3>ZOOM</h3></a>	
							</div>
								  	...
								  	@for ($i = 0; $i <= 3 ; $i++) 				  				
										<div class="item {{ $i == 1 ? 'active':'' }}">
											@foreach ($getImage as $img)		
											  	<a><img src="{{ asset('uploads/product/'. $img) }}" alt="" width="80px"></a>
											@endforeach
										</div>	
									@endfor
								</div>
...
<script>
	$(document).ready(function(){
		$("img").click(function(){
			...
			$("img.imgBig").attr("src", x);
		});

		$("a.zoom").click(function() {
			var y = $("img.imgBig").attr("src");
